...
const EVENTS = [
    {
        ...
        capacity: '—',
        link: 'https://www.instagram.com/p/DUnBbUnjDXn/?utm_source=ig_web_copy_link&igsh=MzRlODBiNWFlZA=='
    },
    {
        id: 2,
                        ...
                        {EVENTS.map((event) => (
                            ...
                            >
                                ...
                                <div className="card-actions">
                                    {event.link ? (
                                        <a href={event.link} target="_blank" rel="noopener noreferrer" className="details-btn" style={{ textDecoration: 'none', display: 'inline-flex', justifyContent: 'center', alignItems: 'center' }}>
                                            {t('calendar.details')}
                                        </a>
                                    ) : (
